...
To run and use the tool we provide the source code of the rascal part and a compiled version of the visualization part with this report. The source code for the rascal part of the project can also be found at \url{https://github.com/piotrkosytorz/software-evolution/tree/master/piotr.kosytorz/series1/src}. The source code for the visualization part can be found at \url{https://github.com/piotrkosytorz/software-evolution/tree/master/piotr.kosytorz/series1/visualization}.
